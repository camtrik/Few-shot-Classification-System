...
################################################################################
## Form generated from reading UI file 'GUI_BASEctpMqq.ui'
##
...
"}")
        ...
        self.label_6 = QLabel(self.page_main)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(10, 30, 1381, 371))
        font5 = QFont()
        ...
        self.label.setGeometry(QRect(250, 360, 882, 190))
        font6 = QFont()
        ...
        self.setsGroupBox = QGroupBox(self.page_home)
        self.setsGroupBox.setObjectName(u"setsGroupBox")

        self.verticalLayout_10.addWidget(self.setsGroupBox)

        self.outputGroupBox = QGroupBox(self.page_home)
        self.outputGroupBox.setObjectName(u"outputGroupBox")
        self.outputTableWidget = QTableWidget(self.outputGroupBox)
        if (self.outputTableWidget.columnCount() < 7):
            self.outputTableWidget.setColumnCount(7)
        ...
        self.outputTableWidget.setHorizontalHeaderItem(4, __qtablewidgetitem4)
        __qtablewidgetitem5 = QTableWidgetItem()
        self.outputTableWidget.setHorizontalHeaderItem(5, __qtablewidgetitem5)
        __qtablewidgetitem6 = QTableWidgetItem()
        self.outputTableWidget.setHorizontalHeaderItem(6, __qtablewidgetitem6)
        if (self.outputTableWidget.rowCount() < 5):
            self.outputTableWidget.setRowCount(5)
        __qtablewidgetitem7 = QTableWidgetItem()
        __qtablewidgetitem7.setFont(font2);
        self.outputTableWidget.setVerticalHeaderItem(0, __qtablewidgetitem7)
        __qtablewidgetitem8 = QTableWidgetItem()
        self.outputTableWidget.setVerticalHeaderItem(1, __qtablewidgetitem8)
        __qtablewidgetitem9 = QTableWidgetItem()
        self.outputTableWidget.setVerticalHeaderItem(2, __qtablewidgetitem9)
        __qtablewidgetitem10 = QTableWidgetItem()
        self.outputTableWidget.setVerticalHeaderItem(3, __qtablewidgetitem10)
        __qtablewidgetitem11 = QTableWidgetItem()
        self.outputTableWidget.setVerticalHeaderItem(4, __qtablewidgetitem11)
        __qtablewidgetitem12 = QTableWidgetItem()
        self.outputTableWidget.setItem(0, 0, __qtablewidgetitem12)
        __qtablewidgetitem13 = QTableWidgetItem()
        self.outputTableWidget.setItem(0, 2, __qtablewidgetitem13)
        __qtablewidgetitem14 = QTableWidgetItem()
        self.outputTableWidget.setItem(0, 3, __qtablewidgetitem14)
        self.outputTableWidget.setObjectName(u"outputTableWidget")
        self.outputTableWidget.setGeometry(QRect(510, 30, 881, 311))
...
#endif
        self.outputTableWidget.setPalette(palette1)
...
"")
        ...
        self.outputTableWidget.horizontalHeader().setMinimumSectionSize(26)
        ...
        self.datasetComboBox = QComboBox(self.outputGroupBox)
        self.datasetComboBox.addItem("")
        self.datasetComboBox.addItem("")
        self.datasetComboBox.addItem("")
        self.datasetComboBox.setObjectName(u"datasetComboBox")
        self.datasetComboBox.setGeometry(QRect(200, 30, 174, 32))
        font7 = QFont()
        font7.setFamily(u"Segoe UI")
        font7.setPointSize(9)
        self.datasetComboBox.setFont(font7)
        self.datasetComboBox.setAutoFillBackground(False)
        self.datasetComboBox.setStyleSheet(u"QComboBox{\n"
"	background-color: rgb(27, 29, 35);\n"
"	border-radius: 5px;\n"
"	border: 2px solid rgb(27, 29, 35);\n"
"	padding: 5px;\n"
...
"	selection-background-color: rgb(39, 44, 54);\n"
"}")
        self.datasetComboBox.setIconSize(QSize(16, 16))
        self.datasetComboBox.setFrame(True)
        self.modelComboBox = QComboBox(self.outputGroupBox)
        self.modelComboBox.addItem("")
        self.modelComboBox.addItem("")
        self.modelComboBox.addItem("")
        self.modelComboBox.addItem("")
        self.modelComboBox.setObjectName(u"modelComboBox")
        self.modelComboBox.setGeometry(QRect(200, 80, 174, 32))
        self.modelComboBox.setFont(font7)
...
"	selection-background-color: rgb(39, 44, 54);\n"
"}")
        self.modelComboBox.setIconSize(QSize(16, 16))
        self.modelComboBox.setFrame(True)
        self.accLineEdit = QLineEdit(self.outputGroupBox)
        self.accLineEdit.setObjectName(u"accLineEdit")
        self.accLineEdit.setGeometry(QRect(200, 140, 141, 30))
        self.accLineEdit.setMinimumSize(QSize(0, 30))
        self.accLineEdit.setStyleSheet(u"QLineEdit {\n"
"	background-color: rgb(27, 29, 35);\n"
"	border-radius: 5px;\n"
"	border: 2px solid rgb(27, 29, 35);\n"
"	padding-left: 10px;\n"
...
"	border: 2px solid rgb(91, 101, 124);\n"
"}")
        self.lossLineEdit = QLineEdit(self.outputGroupBox)
        self.lossLineEdit.setObjectName(u"lossLineEdit")
        self.lossLineEdit.setGeometry(QRect(200, 190, 141, 30))
        self.lossLineEdit.setMinimumSize(QSize(0, 30))
        self.lossLineEdit.setStyleSheet(u"QLineEdit {\n"
"	background-color: rgb(27, 29, 35);\n"
"	border-radius: 5px;\n"
"	border: 2px solid rgb(27, 29, 35);\n"
"	padding-left: 10px;\n"
...
"}")
        self.runButton = QPushButton(self.outputGroupBox)
        self.runButton.setObjectName(u"runButton")
        self.runButton.setGeometry(QRect(80, 300, 291, 31))
        self.runButton.setMinimumSize(QSize(150, 30))
        self.runButton.setFont(font7)
...
"	border: 2px solid rgb(43, 50, 61);\n"
"}")
        self.analyzeButton = QPushButton(self.outputGroupBox)
        self.analyzeButton.setObjectName(u"analyzeButton")
        self.analyzeButton.setGeometry(QRect(80, 350, 291, 31))
        self.analyzeButton.setMinimumSize(QSize(150, 30))
        self.analyzeButton.setFont(font7)
...
"}")
        ...
        self.verticalLayout_10.addWidget(self.outputGroupBox)
...
"}")
        ...
        self.tableWidget.setItem(0, 0, __qtablewidgetitem36)
        __qtablewidgetitem37 = QTableWidgetItem()
        self.tableWidget.setItem(0, 2, __qtablewidgetitem37)
        __qtablewidgetitem38 = QTableWidgetItem()
        self.tableWidget.setItem(0, 3, __qtablewidgetitem38)
        __qtablewidgetitem39 = QTableWidgetItem()
        self.tableWidget.setItem(0, 4, __qtablewidgetitem39)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"\u57fa\u4e8e\u5ea6\u91cf\u5b66\u4e60\u7684\u5c0f\u6837\u672c\u56fe\u50cf\u5206\u7c7b\u7cfb\u7edf", None))
        self.label.setText(QCoreApplication.translate("MainWindow", u"\u8ba1\u79d118-5\u73ed \u5f20\u6d77\u5929", None))
        self.setsGroupBox.setTitle(QCoreApplication.translate("MainWindow", u"Task", None))
        self.outputGroupBox.setTitle(QCoreApplication.translate("MainWindow", u"Outcome", None))
        ...
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", u"Query_1", None));
        ___qtablewidgetitem2 = self.outputTableWidget.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"Query_2", None));
        ___qtablewidgetitem3 = self.outputTableWidget.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", u"Query_3", None));
        ___qtablewidgetitem4 = self.outputTableWidget.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MainWindow", u"Query_4", None));
        ___qtablewidgetitem5 = self.outputTableWidget.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("MainWindow", u"Query_5", None));
        ___qtablewidgetitem6 = self.outputTableWidget.horizontalHeaderItem(6)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("MainWindow", u"Accuracy", None));
        ___qtablewidgetitem7 = self.outputTableWidget.verticalHeaderItem(0)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("MainWindow", u"New Row", None));
        ___qtablewidgetitem8 = self.outputTableWidget.verticalHeaderItem(1)
        ___qtablewidgetitem8.setText(QCoreApplication.translate("MainWindow", u"New Row", None));
        ___qtablewidgetitem9 = self.outputTableWidget.verticalHeaderItem(2)
        ___qtablewidgetitem9.setText(QCoreApplication.translate("MainWindow", u"New Row", None));
        ___qtablewidgetitem10 = self.outputTableWidget.verticalHeaderItem(3)
        ___qtablewidgetitem10.setText(QCoreApplication.translate("MainWindow", u"New Row", None));
        ___qtablewidgetitem11 = self.outputTableWidget.verticalHeaderItem(4)
        ...
        self.datasetComboBox.setItemText(0, QCoreApplication.translate("MainWindow", u"omniglot", None))
        self.datasetComboBox.setItemText(1, QCoreApplication.translate("MainWindow", u"mini-imagenet", None))
        self.datasetComboBox.setItemText(2, QCoreApplication.translate("MainWindow", u"CUB", None))

        self.modelComboBox.setItemText(0, QCoreApplication.translate("MainWindow", u"proto_1", None))
        self.modelComboBox.setItemText(1, QCoreApplication.translate("MainWindow", u"proto_2", None))
        self.modelComboBox.setItemText(2, QCoreApplication.translate("MainWindow", u"relation_1", None))
        self.modelComboBox.setItemText(3, QCoreApplication.translate("MainWindow", u"relation_2", None))

        self.accLineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"acc", None))
        self.lossLineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"loss", None))
        self.labelBoxBlenderInstalation_2.setText(QCoreApplication.translate("MainWindow", u"Model", None))
        self.labelBoxBlenderInstalation_3.setText(QCoreApplication.translate("MainWindow", u"Dataset", None))
        self.labelBoxBlenderInstalation_4.setText(QCoreApplication.translate("MainWindow", u"Accuracy", None))
        self.labelBoxBlenderInstalation_5.setText(QCoreApplication.translate("MainWindow", u"Loss", None))
        self.sampleButton.setText(QCoreApplication.translate("MainWindow", u"\u968f\u673a\u62bd\u53d6", None))
        self.runButton.setText(QCoreApplication.translate("MainWindow", u"\u8fd0\u884c\u7ed3\u679c", None))
        self.analyzeButton.setText(QCoreApplication.translate("MainWindow", u"\u5206\u6790\u7ed3\u679c", None))
        ...
        ___qtablewidgetitem30 = self.tableWidget.verticalHeaderItem(13)
        ___qtablewidgetitem30.setText(QCoreApplication.translate("MainWindow", u"New Row", None));
        ___qtablewidgetitem31 = self.tableWidget.verticalHeaderItem(14)
        ___qtablewidgetitem31.setText(QCoreApplication.translate("MainWindow", u"New Row", None));
        ___qtablewidgetitem32 = self.tableWidget.verticalHeaderItem(15)
        ...
        self.tableWidget.setSortingEnabled(False)
        ___qtablewidgetitem33 = self.tableWidget.item(0, 0)
        ...
        ___qtablewidgetitem34.setText(QCoreApplication.translate("MainWindow", u"Text", None));
        ___qtablewidgetitem35 = self.tableWidget.item(0, 3)
        ___qtablewidgetitem35.setText(QCoreApplication.translate("MainWindow", u"Cell", None));
        ___qtablewidgetitem36 = self.tableWidget.item(0, 4)
        ___qtablewidgetitem36.setText(QCoreApplication.translate("MainWindow", u"Line", None));
